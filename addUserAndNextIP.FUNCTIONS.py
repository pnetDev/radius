...
"""
 ...
 The script then finds the next free IP address which can be allocated to a PPPoE users.
 ...
 Once an IP has been assigned to a user the Leased field is set to 'PPPoE-User'. This means the IP can't be used again.
 ...
 200122 Cleaner code, using better use of functions. 
...
generateResidentialConfig(sharedNetwork,manIP,userName,password)
